							...
							<li>
								<div className="flex items-center justify-center bg-white">
									<div className="relative scale-75">
										...
										{wishList.length ? <span className="absolute -top-2 left-4 rounded-full bg-green-500 p-0.5 px-2 text-sm text-red-50">{wishList.length}</span> : ''}
									</div>
								</div>
							</li>
							<li onClick={clickHandler} className="cursor-pointer">
								<div className="flex items-center justify-center bg-white">
									<div className="relative scale-75">
										...
										{orders.length ? <span className="absolute -top-2 left-4 rounded-full bg-green-500 p-0.5 px-2 text-sm text-red-50">{orders.length}</span> : ''}
									</div>
								</div>
